...
def send_verification_email(name: str, email: str, token: str):
    print(f"[EMAIL] Sending to: {email} from: {GMAIL_USER}")
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px; background-color: #f5f0e8;">
        <div style="background-color: white; border-radius: 16px; padding: 48px; border: 1px solid #e2d9c8;">
            <h1 style="font-size: 28px; color: #1a2744; margin-bottom: 8px;">Resume<span style="color: #c84b2f;">IQ</span></h1>
            ...
            <a href="{verification_link}" style="display: inline-block; background-color: #c84b2f; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px;">
                Verify Email →
            </a>
